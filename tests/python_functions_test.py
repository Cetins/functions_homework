...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    ...
    self.assertEqual( 27, cube_volume_result )

#   Given a String, return the String reversed
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    #add test code here
    reversed_string = reverse_string("Madagaskar")
    self.assertEqual(reversed_string, "raksagadaM")

  #Given a value in farenheit, convert this into celsius.
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    #add test code here
    converted_temperature = fahrenheit_to_celcius(90)
    self.assertEqual( 32, converted_temperature)
